...
public class ProviderSettingsDialog extends JDialog {
	...
	private static final Provider[] PROVIDERS = { new Provider("themoviedb", "TMDB", true), new Provider("thetvdb", "TheTVDB v4", true), new Provider("thetvdb.pin", "TheTVDB subscriber PIN", false), new Provider("opensubtitles", "OpenSubtitles", true), new Provider("omdb", "OMDb", true), new Provider("fanart.tv", "Fanart.tv", true), new Provider("acoustid", "AcoustID", false), new Provider("anidb", "AniDB client", false) };
